...
import './XD_Registerphone1.dart';

class XD_Signup6 extends StatelessWidget {
  XD_Signup6({
    Key key,
  }) : super(key: key);
  @override
        ...
        children: <Widget>[
          ...
          Transform(
            transform: Matrix4(
                ...
                1.0),
            child:
                // Adobe XD layer: 'tick_filled_yellow' (shape)
                Container(
              width: 23.0,
              height: 23.0,
              decoration: BoxDecoration(
