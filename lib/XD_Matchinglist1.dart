...
class XD_Matchinglist1 extends StatelessWidget {
  XD_Matchinglist1({
    Key key,
  }) : super(key: key);
  @override
      ...
      body: Stack(
        children: <Widget>[
          ...
          Transform.translate(
            ...
            child:
                // Adobe XD layer: 'matched_filled_yell…' (shape)
                Container(
              width: 40.0,
              height: 40.0,
              decoration: BoxDecoration(
