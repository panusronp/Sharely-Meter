...
import './XD_Addmatching4.dart';
import 'package:flutter_svg/flutter_svg.dart';

class XD_Addmatching3 extends StatelessWidget {
  XD_Addmatching3({
    Key key,
  }) : super(key: key);
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          // Adobe XD layer: 'IMG_BDCC1E7167EE-1' (shape)
          Container(
            width: 414.0,
            height: 896.0,
...
const String _svg_wh7q2i =
    '<svg viewBox="59.5 644.5 1.0 18.0" ><path transform="translate(59.5, 644.5)" d="M 0 0 L 0 18" fill="none" stroke="#707070" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
