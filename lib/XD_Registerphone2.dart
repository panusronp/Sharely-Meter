...
import './XD_Phoneverification1.dart';

class XD_Registerphone2 extends StatelessWidget {
  XD_Registerphone2({
    Key key,
  }) : super(key: key);
  @override
      ...
      body: Stack(
        children: <Widget>[
          ...
          Transform.translate(
            ...
            child: Text(
              'Enter your mobile number to enable 2-step \nverification',
              style: TextStyle(
                fontFamily: 'SF Pro Display',
                fontSize: 18,
                color: const Color(0xff3d4349),
          ...
          Transform.translate(
            ...
            child:
                // Adobe XD layer: 'Phone number' (shape)
                Container(
              width: 336.0,
              height: 56.0,
              decoration: BoxDecoration(
