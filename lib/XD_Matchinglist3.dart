...
import './XD_Matchinglist2.dart';

class XD_Matchinglist3 extends StatelessWidget {
  XD_Matchinglist3({
    Key key,
  }) : super(key: key);
  @override
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Transform.translate(
            offset: Offset(317.0, 203.0),
            child:
                // Adobe XD layer: 'IMG_0441' (shape)
                Container(
              width: 75.0,
              height: 75.0,
              decoration: BoxDecoration(
          ...
          Transform.translate(
            offset: Offset(38.5, 233.0),
            child: Container(
              width: 264.0,
              height: 58.0,
              decoration: BoxDecoration(
                borderRadius: BorderRadius.circular(14.0),
                color: const Color(0xfff4a142),
              ),
            ),
          ),
          Transform.translate(
          ...
          Transform.translate(
            ...
            child:
              ...
              height: 78.0,
              decoration: BoxDecoration(
                borderRadius: BorderRadius.all(Radius.elliptical(37.5, 39.0)),
                image: DecorationImage(
                  image: const AssetImage(''),
                  fit: BoxFit.cover,
                ),
...
const String _svg_zgtdao =
    '<svg viewBox="94.5 109.4 35.0 34.1" ><path transform="matrix(0.656059, -0.75471, 0.75471, 0.656059, 94.5, 124.53)" d="M 9.999999046325684 0 L 20 29 L 0 29 Z" fill="#3d4eb0" stroke="none" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
const String _svg_rmsl43 =
    '<svg viewBox="284.0 217.4 35.0 34.1" ><path transform="matrix(0.656059, 0.75471, -0.75471, 0.656059, 305.88, 217.44)" d="M 9.999998092651367 0 L 19.99999809265137 29 L 0 29 Z" fill="#f49f3f" stroke="none" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
